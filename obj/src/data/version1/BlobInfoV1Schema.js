...
class BlobInfoV1Schema extends pip_services_commons_node_1.ObjectSchema {
    constructor() {
        super();
        /* Identification */
        ...
        /* Content */
        this.withOptionalProperty('size', pip_services_commons_node_2.TypeCode.Long);
        this.withOptionalProperty('content_type', pip_services_commons_node_2.TypeCode.String);
        this.withOptionalProperty('create_time', null); //TypeCode.DateTime);
        this.withOptionalProperty('expire_time', null); //TypeCode.DateTime);
        this.withOptionalProperty('completed', pip_services_commons_node_2.TypeCode.Boolean);
        /* Custom fields */
