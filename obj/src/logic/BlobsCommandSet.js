...
class BlobsCommandSet extends pip_services_commons_node_1.CommandSet {
    constructor(logic) {
        super();
        this._logic = logic;
    ...
    makeGetBlobsByFilterCommand() {
        return new pip_services_commons_node_2.Command("get_blobs_by_filter", new pip_services_commons_node_5.ObjectSchema(true)
    ...
    makeGetBlobByIdCommand() {
        return new pip_services_commons_node_2.Command("get_blob_by_id", new pip_services_commons_node_5.ObjectSchema(true)
    ...
    makeGetBlobUriByIdCommand() {
        return new pip_services_commons_node_2.Command("get_blob_uri_by_id", new pip_services_commons_node_5.ObjectSchema(true)
            .withRequiredProperty("blob_id", pip_services_commons_node_7.TypeCode.String), (correlationId, args, callback) => {
            let blobId = args.getAsNullableString("blob_id");
    ...
    makeBeginBlobWriteCommand() {
        return new pip_services_commons_node_2.Command("begin_blob_write", new pip_services_commons_node_5.ObjectSchema(true)
    ...
    makeWriteBlobChunkCommand() {
        return new pip_services_commons_node_2.Command("write_blob_chunk", new pip_services_commons_node_5.ObjectSchema(true)
            .withRequiredProperty("token", pip_services_commons_node_7.TypeCode.String)
            .withRequiredProperty("chunk", pip_services_commons_node_7.TypeCode.String), (correlationId, args, callback) => {
    ...
    makeEndBlobWriteCommand() {
        return new pip_services_commons_node_2.Command("end_blob_write", new pip_services_commons_node_5.ObjectSchema(true)
            .withRequiredProperty("token", pip_services_commons_node_7.TypeCode.String)
            .withRequiredProperty("chunk", pip_services_commons_node_7.TypeCode.String), (correlationId, args, callback) => {
            let token = args.getAsNullableString("token");
            let chunk = args.getAsNullableString("chunk");
    ...
    makeAbortBlobWriteCommand() {
        return new pip_services_commons_node_2.Command("abort_blob_write", new pip_services_commons_node_5.ObjectSchema(true)
            .withRequiredProperty("token", pip_services_commons_node_7.TypeCode.String), (correlationId, args, callback) => {
            let token = args.getAsNullableString("token");
    ...
    makeBeginBlobReadCommand() {
        return new pip_services_commons_node_2.Command("begin_blob_read", new pip_services_commons_node_5.ObjectSchema(true)
            .withRequiredProperty("blob_id", pip_services_commons_node_7.TypeCode.String), (correlationId, args, callback) => {
            let blobId = args.getAsNullableString("blob_id");
    ...
    makeReadBlobChunkCommand() {
        return new pip_services_commons_node_2.Command("read_blob_chunk", new pip_services_commons_node_5.ObjectSchema(true)
            .withRequiredProperty("blob_id", pip_services_commons_node_7.TypeCode.String)
            .withRequiredProperty("skip", pip_services_commons_node_7.TypeCode.Long)
            .withRequiredProperty("take", pip_services_commons_node_7.TypeCode.Long), (correlationId, args, callback) => {
            let blobId = args.getAsNullableString("blob_id");
    ...
    makeEndBlobReadCommand() {
        return new pip_services_commons_node_2.Command("end_blob_read", new pip_services_commons_node_5.ObjectSchema(true)
            .withRequiredProperty("blob_id", pip_services_commons_node_7.TypeCode.String), (correlationId, args, callback) => {
            let blobId = args.getAsNullableString("blob_id");
    ...
    makeUpdateBlobInfoCommand() {
        return new pip_services_commons_node_2.Command("update_blob_info", new pip_services_commons_node_5.ObjectSchema(true)
            .withRequiredProperty("blob", new BlobInfoV1Schema_1.BlobInfoV1Schema()), (correlationId, args, callback) => {
            let blob = args.get("blob");
    ...
    makeMarkBlobsCompletedCommand() {
        return new pip_services_commons_node_2.Command("mark_blobs_completed", new pip_services_commons_node_5.ObjectSchema(true)
            .withRequiredProperty("blob_ids", new pip_services_commons_node_6.ArraySchema(pip_services_commons_node_7.TypeCode.String)), (correlationId, args, callback) => {
    ...
    makeDeleteBlobsByIdsCommand() {
        return new pip_services_commons_node_2.Command("delete_blobs_by_ids", new pip_services_commons_node_5.ObjectSchema(true)
            .withRequiredProperty("blob_ids", new pip_services_commons_node_6.ArraySchema(pip_services_commons_node_7.TypeCode.String)), (correlationId, args, callback) => {
            let blobIds = args.get("blob_ids");
