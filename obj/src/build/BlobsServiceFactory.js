...
class BlobsServiceFactory extends pip_services_components_node_1.Factory {
    constructor() {
        super();
...
BlobsServiceFactory.Descriptor = new pip_services_commons_node_1.Descriptor("pip-services-blobs", "factory", "default", "default", "1.0");
BlobsServiceFactory.MemoryPersistenceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-blobs", "persistence", "memory", "*", "1.0");
BlobsServiceFactory.FilePersistenceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-blobs", "persistence", "file", "*", "1.0");
BlobsServiceFactory.MongoDbPersistenceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-blobs", "persistence", "mongodb", "*", "1.0");
BlobsServiceFactory.S3PersistenceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-blobs", "persistence", "s3", "*", "1.0");
BlobsServiceFactory.ControllerDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-blobs", "controller", "default", "*", "1.0");
BlobsServiceFactory.SenecaServiceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-blobs", "service", "seneca", "*", "1.0");
BlobsServiceFactory.HttpServiceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-blobs", "service", "http", "*", "1.0");
